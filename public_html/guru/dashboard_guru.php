...
// Query untuk mengambil data kelas yang diajar oleh guru
$sqlKelasGuru = "SELECT kelas.id, kelas.nama_kelas, guru_mata_pelajaran.mata_pelajaran_id, mata_pelajaran.nama
                 FROM kelas
...
$resultKelasGuru = $conn->query($sqlKelasGuru);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Selamat Datang, <?php echo "$username" ?></h1>
                    <h3 class="h3 mb-4 text-gray-800">Ini Adalah Dashboard Milik <?php echo "$username" ?></h3>


                    <!-- Card Kelas yang Diajar -->
                    <?php
                    while ($rowKelasGuru = $resultKelasGuru->fetch_assoc()) {
                        echo "<div class='card mb-4'>";
                        echo "<div class='card-header'>";
                        echo "<h6 class='m-0 font-weight-bold'>" . $rowKelasGuru['nama_kelas'] . "</h6>";
                        echo "</div>";
                        echo "<div class='card-body'>";
                        echo "<p>Mata Pelajaran: " . $rowKelasGuru['nama'] . "</p>";
                        echo "<a href='absensi.php?id=" . $rowKelasGuru['id'] . "' class='btn btn-primary'>Lihat Kelas</a>";
                        echo "</div>";
                        echo "</div>";
                    }
                    ?>
