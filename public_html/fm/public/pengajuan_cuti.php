...
// Anda dapat menyesuaikan ini sesuai dengan mekanisme otentikasi atau sesi yang Anda gunakan
session_start();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 class="mb-4">Pengajuan Cuti</h2>

                    <!-- Formulir Pengajuan Cuti -->
                    <form action="../../backend/pengajuan_cuti_process.php" method="post">
