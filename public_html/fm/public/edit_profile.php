                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../../backend/update_profile.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="jatah_cuti" class="col-sm-2 col-form-label">Jatah Cuti:</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="jatah_cuti" name="jatah_cuti"
                                                    value="<?php echo $user['jatah_cuti']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="tel" class="form-control" id="nomor_telepon"
                                                    name="nomor_telepon" value="<?php echo $user['nomor_telepon']; ?>"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="tanggal_bergabung" class="col-sm-2 col-form-label">Tanggal Bergabung:</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="tanggal_bergabung"
                                                    name="tanggal_bergabung" value="<?php echo $user['tanggal_bergabung']; ?>"
                                                    readonly>
                                            </div>
                                        </div>
