...
$sqlGetIDs = "SELECT id FROM users WHERE id NOT IN (SELECT id FROM guru)";
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                ...
                                <form action="../../backend/func/create_user.php" method="post">
                                    <h2>Create User</h2>
                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form action="../../backend/func/process_input_guru.php" method="post">
                                        <h2>Data Guru</h2>
