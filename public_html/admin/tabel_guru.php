                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                // Gantilah "nama_tabel_guru" dan "nama_kolom" sesuai dengan struktur database Anda
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                // Contoh:
                                                // echo "<td>" . $row['kolom_lain'] . "</td>";
                                                echo "<td>
                                                    <a href='view_guru.php?id=" . $row['id'] . "'><i class='fas fa-eye'></i></a>
                                                    <a href='edit_guru.php?id=" . $row['id'] . "'><i class='fas fa-edit'></i></a>
                                                    <a href='hapus_guru.php?id=" . $row['id'] . "'><i class='fas fa-trash'></i></a>
                                                </td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                ...
                                <?php
                                    ...
                                    echo "<p class='text-center'>Tidak ada data guru.</p>";
                                }
                                ?>
                            </div>
                        </div>
