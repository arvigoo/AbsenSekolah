...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="rolepel.php">
                    <i class="fas fa-fw fa-book"></i>
                    <span>Role Guru</span>
                </a>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="tabel_guru.php" class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Guru</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php //echo $totalGuru; 
                                                                                                ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <!-- Murid Card -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="tabel_siswa.php" class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Murid</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php //echo $totalMurid; 
                                                                                                ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <!-- Mata Pelajaran Card -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="tabel_mapel.php" class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Mata Pelajaran</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php //echo $totalMataPelajaran; 
                                                                                                ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <!-- Kelas Card -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="tabel_kelas.php" class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Kelas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php //echo $totalKelas; 
                                                                                                ?></div>
                                        </div>
                                        <div class="col-auto">
