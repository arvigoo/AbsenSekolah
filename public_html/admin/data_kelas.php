        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 class="mb-4">Form Input Data Kelas</h2>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form action="process_input_kelas.php" method="post">

                                        <!-- Nama Kelas, Tingkat, ID Wali Kelas -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tingkat" class="form-control" required>
                                                ...
                                                <!-- ... (Tambahkan tingkat lain sesuai kebutuhan) ... -->
                                            </select>
                                        </div>
